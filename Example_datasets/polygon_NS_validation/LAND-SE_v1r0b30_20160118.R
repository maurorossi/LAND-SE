...
if (length(table(pars == "-wd"))==2)
  ...
  {
  #wd_selected<-"/polygon_NS_validation/" # linux
  wd_selected<-"C:/polygon_NS_validation/" # windows
  }
setwd(wd_selected)
...
if (length(table(pars == "-cd"))==2)
  ...
  {
  #cd_selected<-"/polygon_NS_validation/" # linux
  cd_selected<-"C:/polygon_NS_validation/" # windows
  }
