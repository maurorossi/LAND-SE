...
if (length(table(pars == "-wd"))==2)
  ...
  {
  #wd_selected<-"/media/disco_dati/R/SusceptibilityAnalysis/Messina_Tool_Paper/soglia2_Random/"
...
if (length(table(pars == "-cd"))==2)
  ...
  {
  #cd_selected<-"/media/disco_dati/R/SusceptibilityAnalysis/Messina_Tool_Paper/soglia2_Random/"
...
enable_probability_optimal_binary_classification<-TRUE
enable_probability_optimal_classification<-TRUE # This require enable_probability_optimal_binary_classification<-TRUE
